...
import type { NavIconName } from "@/site.config";

// Shared by the sidebar navigation and the gallery filter pills. Images and
// Vidéos exist in both places, and the same idea should not be drawn twice.
export const ICONS: Record<NavIconName, ReactNode> = {
  discover: (
